...
const cartVal = (0, _database.ref)(database, "CartList");
let inputEl = document.getElementById("input-el");
let addBtn = document.getElementById("add-button");
const cartList = document.getElementById("cart-list");
addBtn.addEventListener("click", function() {
    let inputVal = inputEl.value;
    (0, _database.push)(cartVal, inputVal);
    clearInput();
});
(0, _database.onValue)(cartVal, (snapshot)=>{
    if (snapshot.exists()) {
    ...
    } else cartList.innerHTML = "No items in the Cart";
});
...
function displayList(item) {
    //cartList.innerHTML += `<li> ${inputVal}</li>`
    ...
    newEl.addEventListener("click", function() {
        let exactLocation = (0, _database.ref)(database, `CartList/${itemID}`);
        (0, _database.remove)(exactLocation);
    });
...
},{"6b38617303e2f7b9":"d5jf4","@firebase/app":"3AcPV","@firebase/component":"bi1VB","@firebase/util":"ePiK6","@firebase/logger":"fZmft","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["km5uZ","bB7Pu"], "bB7Pu", "parcelRequiredd25")
